...
<html lang="it" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../dist/indexIMP.css">
  	<link rel="stylesheet" href="..\node_modules\bootstrap\dist\css\bootstrap.min.css">

  </head>
  <body class="font-merriweather">

    <?php include("../common/navbar.php");stamp(3);?>
        ...
        if ($_SESSION["ruolo"] == 1 || $_SESSION["ruolo"] == 2) {
          ...
          <div class="row">
            <div class="col-md-1 offset-md-11 p-0 mt-4">
              <a href="../Add Page/addIMP.php"><button class="btn btn-info" name="button">Aggiungi</button></a>
            </div>
          </div>
          ';
        }
    ...
    <script type="text/javascript" src="..\dist\indexIMP.bundle.js"></script>
